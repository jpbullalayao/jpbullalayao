...
- Pokemon VGC Agent — Building an agent to help Pokemon competitors prepare for official competition
  ...
  - [pokemon-vgc-calc-mcp](https://github.com/jpbullalayao/pokemon-vgc-calc-mcp) — MCP Server for performing Pokemon damage calculations
...
- [Wedding Seating Chart](https://weddingseatingchart.app/) — Launched wedding software to solve personal problem; now serves paying customers around the world
- [Victory Road](https://victoryroad.pro) — Created damage calculator web app for well-respected organization within Pokemon VGC community
